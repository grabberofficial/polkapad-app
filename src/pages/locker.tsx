      ...
      return (
        <Flex
          ...
          <Flex marginLeft={'20px'} flexDirection={'column'}>
            <Text fontSize='14px' fontWeight={500}>{step.title}</Text>
      ...
      <>
        ...
        <Flex alignItems={'flex-start'} className="main-block">
          ...
          >
            ...
            <Text>
            Choose what suits you best. Lock DOT and KSM to receive allocation in first sales.
            <br/>
                ...
                <Flex
                    ...
                    <Flex
                        ...
                        <TabList margin={'10px'} justifyContent={'space-between'}>
                            ...
                            <Tab isDisabled _disabled={{ color: 'gray'}}>Mooriver</Tab>
                            <Tab isDisabled _disabled={{ color: 'gray'}}>Shiden</Tab>
                        </TabList>
                    </Flex>
                    <Flex
                        flexDirection={'column'}
          ...
          <Flex
            ...
            <Heading marginBottom={75}>
                Locked Amount
            </Heading>
            <Text marginBottom='30px'>
              Funds can be locked only at sale event.
              There is no way to put it after sale and before Polkapad mainnet
            </Text>
            {!account && (
            ...
            {account && (
              <>
                    ...
                    <Flex marginBottom={'25px'}>
                      <Text>{item.from}</Text>
                        <Flex
                          ...
                          flexGrow={1}
                          ></Flex>
                        <Text fontWeight={700}>{item.amount} {item.amount > 0 ? 'DOT' : ''}</Text>
                    </Flex>
                  ))}
                  <Flex marginBottom={'25px'}>
                ...
                <Flex gap='36px' marginBottom='40px'>
                  <Button variant='primary' width='100px'>Buy more</Button>
                  <Button variant='secondary' width='120px'>Withdraw funds</Button>
                </Flex>
                <Flex>
                  <Text marginRight='5px'>Don't see provied funds?</Text>
                  <Text color='#49C7DA' fontWeight={700}>Contact support</Text>
                </Flex>
              </>
            )}
          </Flex>
