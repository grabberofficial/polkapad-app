...
const ProfilePage = () => {
  ...
  return (
    <Fragment>
      {' '}
      <Flex padding={["40px 16px", "40px 16px", "76px 155px 0"]} flexDirection="column">
        <Heading marginBottom={101} withUnderline>
          User Profile
        </Heading>

        <Flex flexDirection={['column', 'column', 'column', 'row']}>
          <Flex direction={["column", "row", "row", "column"]} gap="30px" flexBasis="30%" mr={[0,0,0,"20px"]} mb={["20px", "20px","20px", 0]}>
            {/* Tab */}
            {tabs.map((tab, index) => (
              <Flex
                gap="11px"
