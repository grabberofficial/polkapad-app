    ...
    <StyledContainer as="footer" role="contentinfo">
      ...
      >
        <FirstStack spacing={{ base: '6', md: '8' }} align="start">
          <Logo />
          <Text color="#8E8E8E">The fully decentralized protocol for launching new ideas</Text>
        </FirstStack>
        <Stack
        ...
        >
          ...
          <LastStack spacing="4">
            ...
            <Stack spacing="4" direction={{ base: 'column', sm: 'row' }} maxW={{ lg: '360px' }} pt="7px">
          ...
          <Stack direction="row" spacing="8">
            ...
            <LastStack spacing="4">
                <ButtonGroup variant="ghost">
                    <StyledIconButton as="a" href="#" aria-label="Twitter"  icon={<FaTwitter fontSize="1.25rem" />} />
                    <StyledIconButton as="a" href="#" aria-label="Telegram" icon={<FaTelegram fontSize="1.25rem" />} />
                    <StyledIconButton as="a" href="#" aria-label="Discord" icon={<FaDiscord fontSize="1.25rem" />} />
                    <StyledIconButton as="a" href="#" aria-label="GitHub" icon={<FaGithub fontSize="1.25rem" />} />
                </ButtonGroup>
            </LastStack>
